...
import type {
  CreatePoolTxInput,
  CreatePoolTxOutput,
} from "../../schemas/pools/createPoolTx.schema";
...
// Usage example same as addLiquidityTxHandler
...
export async function createPoolTxHandler(
  input: CreatePoolTxInput,
): Promise<CreatePoolTxOutput> {
  const {
    user,
    tokenXMint,
    tokenYMint,
